...
Socket.prototype.trigger = function(ev)
{
  ...
  switch(args.length)
  {
    ...
    case 1:
      ...
      break;
    case 2:
      router.emit(ev, this, args[1]);
      break;
    case 3:
      router.emit(ev, this, args[1], args[2]);
      break;
    case 4:
      router.emit(ev, this, args[1], args[2], args[3]);
      break;
    default:
      args = Array.prototype.slice.call(arguments);
      args.splice(1, 0, this);
      router.emit.apply(router, args);
  }
};
...
{
  if (this.nsp.router.listensOn('error'))
  {
