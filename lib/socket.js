...
function Socket(nsp, client, query)
{
  ...
  this.router.on('packet', this.onPacket.bind(this));
  this.router.on('connect', this.onConnect.bind(this));
  this.router.on('connection', this.onConnect.bind(this));
  this.router.on('disconnect', this.onDisconnect.bind(this));
  this.router.on('disconnection', this.onDisconnect.bind(this));
}
 ...
 * @returns {Socket} self
 */
Socket.prototype.use = function(router)
{
  var context =
  {
    nsp: this.nsp,
  ...
  router.forEach(function bind(route)
  {
 ...
 * @returns {Route}
 */
Socket.prototype.on = function(event, handlers)
{
...
Socket.prototype.broadcast = function(ev)
{
  ...
  .nsp
  .broadcast
  .apply(this.nsp.except(this.id), arguments);
...
Socket.prototype.onPacket = function(packet)
{
  ...
  switch (packet.type)
  {
    ...
    case parser.ERROR:
      this.trigger('error', packet.data);
  }
};
...
Socket.prototype.onClose = function(reason)
{
  ...
  this.trigger('disconnection', reason);
};
