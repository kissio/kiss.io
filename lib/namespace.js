...
/**
 * Shortcut for Namespace.router.setEmitter that also sets the default
 * ..router options that the namespace sockets inherit to given `opts`.
 *
 * Use this instead of Namespace.router.setEmitter.
 *
 * @see Router.setEmitter
 * @access public
 *
 ...
 * ..emitter constructor.
 */
Namespace.prototype.setEmitter = function(emitter, opts)
{
  // save emitter opts
  opts = opts || this.opts.router;
  this.opts.router = opts || {};

  // save emitter c'tor function.
  this.opts.router.emitter = emitter;

  // initiate router emitter
  this.router.setEmitter(emitter, opts);
};
